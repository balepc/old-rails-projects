ActionController::Routing::Routes.draw do |map|
  ...
  map.connect '/export/items.xml', :controller=>"Export", :action=>'items'
  map.connect '/export/models.xml', :controller=>"Export", :action=>'models'
  map.connect '/export/articules.xml', :controller=>"Export", :action=>'articules'
  map.connect '/export/codes.xml', :controller=>"Export", :action=>'codes'
  map.connect '/export/documents.xml', :controller=>"Export", :action=>'documents'

  map.resources :items
  map.resources :documents, :member=>{:download=>:get, :download_base=>:get}
